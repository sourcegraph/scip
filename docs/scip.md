...
| repeated **symbols**     | SymbolInformation | Non-local symbols that are defined within this document.                                                                                                                                                                                                                           |
...
| **symbol**                          | string     | (optional) The symbol that appears at this position. See `Symbol`'s doc comment for how to format symbols as strings.                                                                                                                                                                                                                                        |
