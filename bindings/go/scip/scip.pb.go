...
const file_scip_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"scip.proto\x12\x04scip\"\xa5\x01\n" +
	"\x05Index\x12*\n" +
	"\bmetadata\x18\x01 \x01(\v2\x0e.scip.MetadataR\bmetadata\x12,\n" +
	"\tdocuments\x18\x02 \x03(\v2\x0e.scip.DocumentR\tdocuments\x12B\n" +
	"\x10external_symbols\x18\x03 \x03(\v2\x17.scip.SymbolInformationR\x0fexternalSymbols\"\xd5\x01\n" +
	"\bMetadata\x12/\n" +
	"\aversion\x18\x01 \x01(\x0e2\x15.scip.ProtocolVersionR\aversion\x12+\n" +
	"\ttool_info\x18\x02 \x01(\v2\x0e.scip.ToolInfoR\btoolInfo\x12!\n" +
	"\fproject_root\x18\x03 \x01(\tR\vprojectRoot\x12H\n" +
	"\x16text_document_encoding\x18\x04 \x01(\x0e2\x12.scip.TextEncodingR\x14textDocumentEncoding\"V\n" +
	"\bToolInfo\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\x12\x1c\n" +
	"\targuments\x18\x03 \x03(\tR\targuments\"\x8b\x02\n" +
	"\bDocument\x12\x1a\n" +
	"\blanguage\x18\x04 \x01(\tR\blanguage\x12#\n" +
	"\rrelative_path\x18\x01 \x01(\tR\frelativePath\x122\n" +
	"\voccurrences\x18\x02 \x03(\v2\x10.scip.OccurrenceR\voccurrences\x121\n" +
	"\asymbols\x18\x03 \x03(\v2\x17.scip.SymbolInformationR\asymbols\x12\x12\n" +
	"\x04text\x18\x05 \x01(\tR\x04text\x12C\n" +
	"\x11position_encoding\x18\x06 \x01(\x0e2\x16.scip.PositionEncodingR\x10positionEncoding\"}\n" +
	"\x06Symbol\x12\x16\n" +
	"\x06scheme\x18\x01 \x01(\tR\x06scheme\x12'\n" +
	"\apackage\x18\x02 \x01(\v2\r.scip.PackageR\apackage\x122\n" +
	"\vdescriptors\x18\x03 \x03(\v2\x10.scip.DescriptorR\vdescriptors\"Q\n" +
	"\aPackage\x12\x18\n" +
	...
	"\rdisambiguator\x18\x02 \x01(\tR\rdisambiguator\x12/\n" +
	"\x06suffix\x18\x03 \x01(\x0e2\x17.scip.Descriptor.SuffixR\x06suffix\"\xa5\x01\n" +
	"\x06Suffix\x12\x15\n" +
	"\x11UnspecifiedSuffix\x10\x00\x12\r\n" +
	"\tNamespace\x10\x01\x12\x0f\n" +
	"\aPackage\x10\x01\x1a\x02\b\x01\x12\b\n" +
	"\x04Type\x10\x02\x12\b\n" +
	"\x04Term\x10\x03\x12\n" +
	"\n" +
	...
	"\x05Class\x10\a\x12\v\n" +
	"\aConcept\x10V\x12\f\n" +
	"\bConstant\x10\b\x12\x0f\n" +
	"\vConstructor\x10\t\x12\f\n" +
	"\bContract\x10>\x12\x0e\n" +
	"\n" +
	"DataFamily\x10\n" +
	"\x12\f\n" +
	"\bDelegate\x10I\x12\b\n" +
	"\x04Enum\x10\v\x12\x0e\n" +
	"\n" +
	"EnumMember\x10\f\x12\t\n" +
	"\x05Error\x10?\x12\t\n" +
	"\x05Event\x10\r\x12\r\n" +
	"\tExtension\x10T\x12\b\n" +
	"\x04Fact\x10\x0e\x12\t\n" +
	...
	"\vStaticEvent\x10N\x12\x0f\n" +
	"\vStaticField\x10O\x12\x10\n" +
	"\fStaticMethod\x10P\x12\x12\n" +
	...
	"\aTheorem\x103\x12\x11\n" +
	"\rThisParameter\x104\x12\t\n" +
	"\x05Trait\x105\x12\x0f\n" +
	"\vTraitMethod\x10F\x12\b\n" +
	"\x04Type\x106\x12\r\n" +
	"\tTypeAlias\x107\x12\r\n" +
	...
	"\x04tags\x18\x05 \x03(\x0e2\x13.scip.DiagnosticTagR\x04tags*1\n" +
	"\x0fProtocolVersion\x12\x1e\n" +
	"\x1aUnspecifiedProtocolVersion\x10\x00*@\n" +
	"\fTextEncoding\x12\x1b\n" +
	"\x17UnspecifiedTextEncoding\x10\x00\x12\b\n" +
	"\x04UTF8\x10\x01\x12\t\n" +
	...
	"\vWriteAccess\x10\x04\x12\x0e\n" +
	"\n" +
	"ReadAccess\x10\b\x12\r\n" +
	"\tGenerated\x10\x10\x12\b\n" +
	"\x04Test\x10 \x12\x15\n" +
	"\x11ForwardDefinition\x10@*\xea\x06\n" +
	"\n" +
	"SyntaxKind\x12\x19\n" +
	"\x15UnspecifiedSyntaxKind\x10\x00\x12\v\n" +
	"\aComment\x10\x01\x12\x18\n" +
	"\x14PunctuationDelimiter\x10\x02\x12\x16\n" +
	"\x12PunctuationBracket\x10\x03\x12\v\n" +
	"\aKeyword\x10\x04\x12\x19\n" +
	"\x11IdentifierKeyword\x10\x04\x1a\x02\b\x01\x12\x16\n" +
	"\x12IdentifierOperator\x10\x05\x12\x0e\n" +
	"\n" +
	"Identifier\x10\x06\x12\x15\n" +
	"\x11IdentifierBuiltin\x10\a\x12\x12\n" +
	"\x0eIdentifierNull\x10\b\x12\x16\n" +
	"\x12IdentifierConstant\x10\t\x12\x1b\n" +
	"\x17IdentifierMutableGlobal\x10\n" +
	"\x12\x17\n" +
	"\x13IdentifierParameter\x10\v\x12\x13\n" +
	"\x0fIdentifierLocal\x10\f\x12\x16\n" +
	"\x12IdentifierShadowed\x10\r\x12\x17\n" +
	"\x13IdentifierNamespace\x10\x0e\x12\x18\n" +
	"\x10IdentifierModule\x10\x0e\x1a\x02\b\x01\x12\x16\n" +
	...
	"\x0eBooleanLiteral\x10!\x12\a\n" +
	"\x03Tag\x10\"\x12\x10\n" +
	"\fTagAttribute\x10#\x12\x10\n" +
	"\fTagDelimiter\x10$\x1a\x02\x10\x01*V\n" +
	"\bSeverity\x12\x17\n" +
	...
	"\x03CSS\x10\x1a\x12\n" +
	"\n" +
	"\x06CSharp\x10\x01\x12\v\n" +
	"\aClojure\x10\b\x12\x10\n" +
	"\fCoffeescript\x10\x15\x12\x0e\n" +
	"\n" +
	"CommonLisp\x10\t\x12\a\n" +
	"\x03Coq\x10/\x12\b\n" +
	"\x04CUDA\x10a\x12\b\n" +
	"\x04Dart\x10\x03\x12\n" +
	"\n" +
	"\x06Delphi\x109\x12\b\n" +
	...
	"\x06FSharp\x10*\x12\b\n" +
	"\x04Fish\x10A\x12\b\n" +
	"\x04Flow\x10\x18\x12\v\n" +
	"\aFortran\x108\x12\x0e\n" +
	"\n" +
	...
	"\aGraphQL\x10b\x12\n" +
	"\n" +
	"\x06Groovy\x10\a\x12\b\n" +
	"\x04HTML\x10\x1e\x12\b\n" +
	"\x04Hack\x10\x14\x12\x0e\n" +
	"\n" +
	"Handlebars\x10Z\x12\v\n" +
	"\aHaskell\x10,\x12\t\n" +
	"\x05Idris\x10.\x12\a\n" +
	"\x03Ini\x10H\x12\x05\n" +
	"\x01J\x103\x12\b\n" +
	...
	"\x05LaTeX\x10S\x12\b\n" +
	"\x04Lean\x100\x12\b\n" +
	"\x04Less\x10\x1b\x12\a\n" +
	"\x03Lua\x10\f\x12\b\n" +
	"\x04Luau\x10l\x12\f\n" +
	"\bMakefile\x10O\x12\f\n" +
	"\bMarkdown\x10T\x12\n" +
	"\n" +
	"\x06Matlab\x104\x12\n" +
	"\n" +
	"\x06Nickel\x10n\x12\a\n" +
	"\x03Nix\x10M\x12\t\n" +
	...
	"PowerShell\x10C\x12\n" +
	"\n" +
	"\x06Prolog\x10G\x12\f\n" +
	"\bProtobuf\x10d\x12\n" +
	"\n" +
	"\x06Python\x10\x0f\x12\x05\n" +
	"\x01R\x106\x12\n" +
	"\n" +
	"\x06Racket\x10\v\x12\b\n" +
	"\x04Raku\x10\x0e\x12\t\n" +
	"\x05Razor\x10>\x12\t\n" +
	"\x05Repro\x10f\x12\b\n" +
	"\x04ReST\x10U\x12\b\n" +
	"\x04Ruby\x10\x10\x12\b\n" +
	"\x04Rust\x10(\x12\a\n" +
	"\x03SAS\x10=\x12\b\n" +
	"\x04SCSS\x10\x1d\x12\a\n" +
	"\x03SML\x10+\x12\a\n" +
	"\x03SQL\x10E\x12\b\n" +
	"\x04Sass\x10\x1c\x12\t\n" +
	...
	"\x06Scheme\x10\n" +
	"\x12\x0f\n" +
	"\vShellScript\x10@\x12\v\n" +
	"\aSkylark\x10N\x12\t\n" +
	"\x05Slang\x10k\x12\f\n" +
	"\bSolidity\x10_\x12\n" +
	"\n" +
	"\x06Svelte\x10j\x12\t\n" +
	"\x05Swift\x10\x02\x12\a\n" +
	"\x03Tcl\x10e\x12\b\n" +
	"\x04TOML\x10I\x12\a\n" +
	"\x03TeX\x10R\x12\n" +
	"\n" +
	...
	"\x0fTypeScriptReact\x10^\x12\v\n" +
	"\aVerilog\x10h\x12\b\n" +
	"\x04VHDL\x10i\x12\x0f\n" +
	"\vVisualBasic\x10?\x12\a\n" +
	"\x03Vue\x10\x19\x12\v\n" +
	"\aWolfram\x105\x12\a\n" +
...
var (
	...
	file_scip_proto_rawDescData []byte
)

func file_scip_proto_rawDescGZIP() []byte {
	file_scip_proto_rawDescOnce.Do(func() {
		file_scip_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_scip_proto_rawDesc), len(file_scip_proto_rawDesc)))
	})
	return file_scip_proto_rawDescData
}

var file_scip_proto_enumTypes = make([]protoimpl.EnumInfo, 10)
var file_scip_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_scip_proto_goTypes = []any{
	...
	(*SingleLineRange)(nil),     // 19: scip.SingleLineRange
	(*MultiLineRange)(nil),      // 20: scip.MultiLineRange
	(*Occurrence)(nil),          // 21: scip.Occurrence
	(*Diagnostic)(nil),          // 22: scip.Diagnostic
}
var file_scip_proto_depIdxs = []int32{
	...
	21, // 6: scip.Document.occurrences:type_name -> scip.Occurrence
	...
	19, // 15: scip.Occurrence.single_line_range:type_name -> scip.SingleLineRange
	20, // 16: scip.Occurrence.multi_line_range:type_name -> scip.MultiLineRange
	4,  // 17: scip.Occurrence.syntax_kind:type_name -> scip.SyntaxKind
	22, // 18: scip.Occurrence.diagnostics:type_name -> scip.Diagnostic
	19, // 19: scip.Occurrence.single_line_enclosing_range:type_name -> scip.SingleLineRange
	20, // 20: scip.Occurrence.multi_line_enclosing_range:type_name -> scip.MultiLineRange
	5,  // 21: scip.Diagnostic.severity:type_name -> scip.Severity
	6,  // 22: scip.Diagnostic.tags:type_name -> scip.DiagnosticTag
...
func file_scip_proto_init() {
	...
	file_scip_proto_msgTypes[11].OneofWrappers = []any{
