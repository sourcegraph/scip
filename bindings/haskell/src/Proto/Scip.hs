...
instance Data.ProtoLens.MessageEnum SymbolRole where
  ...
  maybeToEnum 128 = Prelude.Just CallSite
  maybeToEnum k
    = Prelude.Just
  ...
  readEnum k
    ...
    | (Prelude.==) k "CallSite" = Prelude.Just CallSite
    | Prelude.otherwise
    = (Prelude.>>=) (Text.Read.readMaybe k) Data.ProtoLens.maybeToEnum
...
instance Prelude.Enum SymbolRole where
  ...
  fromEnum CallSite = 128
  fromEnum (SymbolRole'Unrecognized (SymbolRole'UnrecognizedValue k))
    = Prelude.fromIntegral k
  succ CallSite
    = Prelude.error
        "SymbolRole.succ: bad argument CallSite. This value would be out of bounds."
  ...
  succ ForwardDefinition = CallSite
  ...
  pred CallSite = ForwardDefinition
...
packedFileDescriptor
  = "\n\
    ...
    \ UTF32CodeUnitOffsetFromLineStart\DLE\ETX*\163\SOH\n\
    \\n\
    \SymbolRole\DC2\EM\n\
