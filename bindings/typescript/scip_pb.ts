...
export type SymbolInformation = Message<"scip.SymbolInformation"> & {
   ...
   *
   * @generated from field: repeated scip.Relationship relationships = 4 [deprecated = true];
   * @deprecated
   */
   ...
   *
   * @generated from field: repeated string implementations = 9;
   */
   ...
   *
   * @generated from field: repeated string references = 10;
   */
  references: string[];
   ...
   *
   * @generated from field: repeated string type_definitions = 11;
   */
