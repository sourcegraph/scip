 ...
 *
 * @generated from message scip.SignatureDocumentation
 */
export type SignatureDocumentation = Message<"scip.SignatureDocumentation"> & {
  /**
...
/**
 * Describes the message scip.SignatureDocumentation.
 * Use `create(SignatureDocumentationSchema)` to create a new message.
 */
export const SignatureDocumentationSchema: GenMessage<SignatureDocumentation> = /*@__PURE__*/
...
export type SymbolInformation = Message<"scip.SymbolInformation"> & {
   ...
   *
   * @generated from field: scip.SignatureDocumentation signature_documentation = 7;
   */
  signatureDocumentation?: SignatureDocumentation;
