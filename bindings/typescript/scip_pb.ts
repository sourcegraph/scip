 ...
 *
 * @generated from message scip.Signature
 */
export type Signature = Message<"scip.Signature"> & {
  /**
...
/**
 * Describes the message scip.Signature.
...
export type SymbolInformation = Message<"scip.SymbolInformation"> & {
   ...
   *
   * @generated from field: scip.Signature signature_documentation = 7;
   */
